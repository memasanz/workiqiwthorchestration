...
AGENT_NAME = "legal-simple-agent"


def load_instructions() -> str:
    print( (Path(__file__).parent / "legal_system_prompt.md").read_text(encoding="utf-8"))
    return (Path(__file__).parent / "legal_system_prompt.md").read_text(encoding="utf-8")
